...
class StateBlockGroupsDownloader2018(BaseDownloader):
    """
    Download 2018 blockgroups for a single state.
    """
    YEAR = 2018
    ...
    @property
    def url(self):
        return f"https://www2.census.gov/geo/tiger/TIGER{self.YEAR}/BG/tl_{self.YEAR}_{self.state.fips}_bg.zip"

    @property
    def zip_name(self):
        return f"tl_{self.YEAR}_{self.state.fips}_bg.zip"
...
class BlockGroupsDownloader2018(BaseDownloader):
    ...
    def __init__(self, data_dir=None):
        ...
        self.merged_path = self.raw_dir.joinpath("blockgroups_us_2018.shp")
